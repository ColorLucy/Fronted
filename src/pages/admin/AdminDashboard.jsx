...
function AdminDashboard({ children }) {
  ...
  const editSections = {
    "Sección de Inicio": <TvIcon />,
    "Sección de Combinaciones": <ListAltIcon />,
    "Sección de Productos": <ListIcon />,
    "Sección de Aliados": <GroupsIcon />,
    "Sección de Contacto": <SettingsPhoneIcon />,
  };
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar
        position="fixed"
        open={open}
        style={{ backgroundColor: "#F2F3F4", color: "black" }}
      >
              ...
              <ListItemButton
                ...
                onClick={(e) =>
                  text === "Editar Pagina de Inicio"
                    ? setOpenHomeE((prev) => !prev)
                    : navigate(pagesUrls[text])
                }
              >
                <ListItemIcon
                  sx={{
                      ...
                      ([textEdit, icon], index) => (
                        <ListItemButton
                          ...
                          onClick={(e) => {
                            ...
                            navigate(
                              pagesUrls["Editar Pagina de Inicio"] +
                                `?edit-page=${encodeURIComponent(textEdit)}`
                            );
                          }}
                          selected={
                            text === "Editar Pagina de Inicio" &&
