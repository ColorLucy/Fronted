...
import { Item, Item2, ItemTittle, ItemTittle2, ItemDynamic } from './orderItems';
                        ...
                        <Grid container spacing={0} >
                            ...
                            <Grid container spacing={1} direction="column" justifyContent="flex-start" alignItems="flex-start" marginLeft={"22px"}>
                                <Grid item xs={4} >
                                    ...
                                    <Item> Nombre: {instance_obj.clienteName} - {instance_obj.email} </Item>
                            ...
                            <Grid container spacing={1} direction="row" justifyContent="center" alignItems="flex-end" marginLeft={"22px"} > 
                                ...
                                <Grid container direction="row" justifyContent="space-between" alignItems="flex-end" marginLeft={"8px"}>
                                    ...
                                    <Grid item xs={2}> <Item textAlign="right">$ {instance_obj.subtotal} </Item> </Grid>
                                </Grid>
                                <Grid container direction="row" justifyContent="space-between" alignItems="flex-end" marginLeft={"8px"}>
                                ...
                                <Grid container direction="row" justifyContent="space-between" alignItems="flex-end" marginLeft={"8px"}>
                                    ...
                                    <Grid item xs={2}> <Item>$ {instance_obj.total} </Item>  </Grid>
                                </Grid>
                            </Grid>
                            <Grid container spacing={0.5} direction="column" justifyContent="center" alignItems="flex-end" marginRight={"32px"} marginBottom={"1px"}>
                                <Grid item >
                                    <Button variant="contained" color="success" onClick={() => handleProductState('Completado')}>Pedido completado</Button>
                                </Grid>
                                <Grid item marginRight={"4px"}>
                                    <Button variant="outlined" color="success" onClick={() => handleProductState('Cancelado')}>Pedido cancelado</Button>
                                </Grid>
                            </Grid>
                        </Grid>
                    </Box>
