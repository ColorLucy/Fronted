...
const SignUp = () => {
  ...
  return (
    <div className="adminPage" style={{ height: "calc(100vh - 80px)" }}>
      <Snackbar open={false} autoHideDuration={5000} TransitionComponent={Grow}>
      ...
      <div className="cardLoginAdmin">
        ...
        >
          Ingresa su información para continuar
        </p>
        ...
        >
          ...
          <FormControl
            variant="filled"
            fullWidth
            error={passwordValidationError !== false}
          >
            <InputLabel htmlFor="filled-adornment-password">
            ...
            <FilledInput
              ...
              onChange={(e) => {
                ...
                setPasswordValidationError(
                  e.target.value !==
                    signUpData.password.slice(0, e.target.value.length)
